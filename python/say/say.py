...
def say(number):
	...
	if -1<number<=999:
		...
		if number%1000==0:
			word=say(number//1000)+' thousand'
		elif number%1000<100:
			word=say(number//1000)+' thousand and '+say(number%1000)
		else:
			word=say(number//1000)+' thousand '+say(number%1000)
  
	elif 999999<number<=999999999:
		if number%1000000==0:
			word=say(number//1000000)+' million'
		elif number%1000000<100:
			word=say(number//1000000)+' million and '+say(number%1000000)
		else:
			word=say(number//1000000)+' million '+say(number%1000000)
  
	elif 999999999<number<=999999999999:
		if number%1000000000==0:
			word=say(number//1000000000)+' billion'
		elif number%1000000000<100:
			word=say(number//1000000000)+' billion and '+say(number%1000000000)
		else:
			word=say(number//1000000000)+' billion '+say(number%1000000000)
	else:
